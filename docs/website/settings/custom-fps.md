...
A value of 0 is special because It will make the project run at the same framerate as the screen instead of a set interval. This also means that the project's scripts may stop running when the project's tab is hidden.
...
You can even use [Scratch Addons](https://scratchaddons.com/) for custom framerates
